function [] = CalculatePlacefields_WM(RoomStr,lengthcrit)
% [] = [] = CalculatePlacefieldsDOM(RoomStr)
% RoomStr, e.g. '201a'

close all;

load(['ProcOut',num2str(lengthcrit),'.mat']); % ActiveFrames NeuronImage NeuronPixels OrigMean FT caltrain NumFrames
...
save(['PlaceMaps',num2str(lengthcrit),'.mat'], 'x', 'y', 't', 'xOutline', 'yOutline', 'speed', 'minspeed', 'FT', 'TMap', 'RunOccMap', 'OccMap', 'SpeedMap', 'RunSpeedMap', 'NeuronImage', 'NeuronPixels', 'cmperbin', 'pval', 'Xbin', 'Ybin', 'FToffset', 'FToffsetRear', 'isrunning', 'cmperbin', 'Xedges', 'Yedges'); 
return;
