function [] = InitializeClusters_WM(NumSegments, SegChain, cc, NumFrames, Xdim, Ydim, lengthcrit)
...
save(['InitClu',num2str(lengthcrit),'.mat'], 'c', 'Xdim', 'Ydim', 'PixelList', 'Xcent', 'Ycent', 'frames', 'meanareas', 'meanX', 'meanY', 'NumFrames', 'NumEvents', 'GoodTrs', '-v7.3');
