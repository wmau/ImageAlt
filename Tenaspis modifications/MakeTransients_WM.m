function [] = MakeTransients_WM(file,todebug,lengthcrit)
...
save(['Segments',num2str(lengthcrit),'.mat'],'NumSegments','SegChain','cc','NumFrames','Xdim','Ydim')
