...
if nargin > 2 
    lengthcrit = varargin{1};
end

load(['PFstats',num2str(lengthcrit),'.mat']); % PFpcthits PFnumhits PFactive PFnumepochs PFepochs MaxPF PFcentroid PFsize PFpixels
load(['PlaceMaps',num2str(lengthcrit),'.mat']); % x y t xOutline yOutline speed minspeed FT TMap RunOccMap OccMap SpeedMap RunSpeedMap NeuronImage NeuronPixels cmperbin pval Xbin Ybin;
...
load(['DumbTraces',num2str(lengthcrit),'.mat']);
